...
function CountdownUnit({ unit, value, index }) {
  return (
    <motion.div
    ...
    >
      <div
        className={`pointer-events-none absolute left-1/2 top-1/2 h-20 w-20 -translate-x-1/2 -translate-y-1/2 rounded-full border ${
          index === 0 ? "border-gold/15" : "border-gold/10"
        }`}
      />

      <p className="relative font-display text-5xl font-medium sm:text-6xl md:text-7xl">
        {String(value).padStart(2, "0")}
      </p>

      <p
        className={`relative mt-3 font-sans text-[8px] uppercase tracking-[0.3em] ${
          index === 0 ? "text-cream/60" : "text-brown/45"
        }`}
      >
        {unit.label}
      </p>
    ...
    <section className="section-transition relative overflow-hidden bg-ivory px-5 py-24 sm:px-8 md:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <motion.h2
          ...
          className="font-display text-6xl text-maroon sm:text-7xl"
        >
        ...
        <motion.p
          ...
          className="mt-5 font-display text-xl italic text-brown/55"
        >
        ...
        {/* Countdown */}
        {timeLeft.started ? (
          <div className="mx-auto mt-14 max-w-xl border border-gold/35 bg-cream px-6 py-12 royal-glow">
